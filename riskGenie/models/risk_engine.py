...
class RiskEngine:
    ...
    def calculate_risk(c: int, i: int, a: int, cvss_score: float, formula_type: str, weights: dict = None) -> float:
        ...
        4. 加權平均法 (weighted_avg): Risk = (W_C * C + W_I * I + W_A * A) * CVSS
        ...
        :param formula_type: 公式類型，支援 'max'、'sum'、'avg'、'weighted_avg'
        :param weights: 自訂權重比例字典，僅在 'weighted_avg' 時使用。
